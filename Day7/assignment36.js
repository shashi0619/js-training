...
const principleAmountPerson3 = readlineSync.question("Enter the principle amount of third person:");
...
if (interestOfPerson1 > interestOfPerson2 && interestOfPerson1 > interestOfPerson3) {
    console.log("First person has more interest: " + interestOfPerson1);
} else if (interestOfPerson2 > interestOfPerson1 && interestOfPerson2 > interestOfPerson3) {
    console.log("Second person has more interest: " + interestOfPerson2);
} else if (interestOfPerson3 > interestOfPerson1 && interestOfPerson3 > interestOfPerson2) {
    console.log("Third person has more interest: " + interestOfPerson3);
} else {
    console.log("Two or more persons have the same highest interest.");
}
