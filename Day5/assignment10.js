//Given the radius of two circles  WAP to find the circle with maximum area
...
if (area1 > area2)
     {
    console.log(" The circle with radius "+  radius1," has the maximum area.");
} 

else 
   {
    console.log( "The circle with radius "+ radius2," has the maximum area.");
   }
